  ...
  const plans = [
    {
      ...
      features: ['10 GB secure storage', 'End-to-end encryption', 'File sharing', '24/7 support'],
    },
    {
      name: 'Pro',
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <p className="text-xl text-center text-gray-600 mb-12">Secure, private, and flexible plans for everyone</p>
