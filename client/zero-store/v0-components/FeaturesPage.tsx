        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-4">
              ...
              <li><Link href="/pricing" className="text-gray-600 hover:text-orange-500">Pricing</Link></li>
              <li><Link href="/login" className="text-gray-600 hover:text-orange-500">Login</Link></li>
            </ul>
          </nav>
        </div>
      </header>
